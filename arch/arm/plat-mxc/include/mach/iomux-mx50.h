...
#define MX50_PAD(_pingrp,_pinname,_usegrp,_usename)	\
		MX50_PAD_##_pingrp##_pinname##__##_usegrp##_usename
...
#define MX50_SD_PAD_CTRL	(PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_DSE_MAX | \
					PAD_CTL_PUS_22K_UP | PAD_CTL_SRE_FAST)

#define MX50_SD_DSL_PAD_CTRL		(PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_DSE_LOW | \
					PAD_CTL_PUS_47K_UP | PAD_CTL_SRE_FAST)

#define MX50_SD_DSM_PAD_CTRL		(PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_DSE_MED | \
					PAD_CTL_PUS_47K_UP | PAD_CTL_SRE_FAST)

#define MX50_SD_DSH_PAD_CTRL		(PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_DSE_HIGH | \
					PAD_CTL_PUS_47K_UP | PAD_CTL_SRE_FAST)


#define MX50_SD_WIFI_PAD_DAT	(PAD_CTL_HYS | PAD_CTL_PKE | PAD_CTL_PUE | \
					PAD_CTL_PUS_47K_UP | PAD_CTL_DSE_HIGH)
#define MX50_SD_WIFI_PAD_CMD	(PAD_CTL_HYS | PAD_CTL_PKE | PAD_CTL_PUE | \
					PAD_CTL_PUS_100K_UP | PAD_CTL_DSE_HIGH)
#define MX50_SD_WIFI_PAD_CLK	(PAD_CTL_PKE | PAD_CTL_PUE | \
					PAD_CTL_PUS_47K_UP | PAD_CTL_DSE_HIGH)

#define MX50_UART_PAD_CTRL	(PAD_CTL_DSE_HIGH | PAD_CTL_PKE)
#define MX50_I2C_PAD_CTRL	(PAD_CTL_ODE | PAD_CTL_DSE_HIGH | \
					PAD_CTL_PUS_22K_UP | PAD_CTL_HYS | PAD_CTL_PUE | PAD_CTL_PKE)
...
#define MX50_EPDC_PAD_CTRL PAD_CTL_DSE_MAX
#define MX50_EPDC_SDCLK_PAD_CTRL PAD_CTL_DSE_MAX



#define MX50_PAD_KEY_COL0__GPIO_4_0	IOMUX_PAD(0x2CC, 0x20, 1, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_KEY_ROW0__GPIO_4_1	IOMUX_PAD(0x2D0, 0x24, 1, 0x0, 0, MX50_KEYPAD_CTRL)
#define MX50_PAD_KEY_COL1__GPIO_4_2	IOMUX_PAD(0x2D4, 0x28, 1, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_KEY_ROW1__GPIO_4_3	IOMUX_PAD(0x2D8, 0x2C, 1, 0x0, 0, MX50_KEYPAD_CTRL)
#define MX50_PAD_KEY_COL2__GPIO_4_4	IOMUX_PAD(0x2DC, 0x30, 1, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_KEY_ROW2__GPIO_4_5	IOMUX_PAD(0x2E0, 0x34, 1, 0x0, 0, MX50_KEYPAD_CTRL)
#define MX50_PAD_KEY_COL3__GPIO_4_6	IOMUX_PAD(0x2E4, 0x38, 1, 0x0, 0, MX50_KEYPAD_CTRL)
#define MX50_PAD_KEY_ROW3__GPIO_4_7	IOMUX_PAD(0x2E8, 0x3C, 1, 0x0, 0, MX50_KEYPAD_CTRL)
#define MX50_PAD_KEY_ROW3__GPIO_4_7_NP	IOMUX_PAD(0x2E8, 0x3C, 1, 0x0, 0, NO_PAD_CTRL)
...
#define MX50_PAD_I2C2_SCL__GPIO_6_20	IOMUX_PAD(0x2F4, 0x48, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN)
#define MX50_PAD_I2C2_SDA__GPIO_6_21	IOMUX_PAD(0x2F8, 0x4C, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN)
#define MX50_PAD_I2C3_SCL__GPIO_6_22	IOMUX_PAD(0x2FC, 0x50, 1, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_I2C3_SDA__GPIO_6_23	IOMUX_PAD(0x300, 0x54, 1, 0x0, 0, MX50_I2C_PAD_CTRL)
...
#define MX50_PAD_PWM2__GPIO_6_25	IOMUX_PAD(0x308, 0x5C, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN)
...
#define MX50_PAD_SSI_TXFS__GPIO_6_0	IOMUX_PAD(0x318, 0x6C, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN)
#define MX50_PAD_SSI_TXC__GPIO_6_1	IOMUX_PAD(0x31C, 0x70, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN)
#define MX50_PAD_SSI_TXD__GPIO_6_2	IOMUX_PAD(0x320, 0x74, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN)
#define MX50_PAD_SSI_RXD__GPIO_6_3	IOMUX_PAD(0x324, 0x78, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN)
#define MX50_PAD_SSI_RXFS__GPIO_6_4	IOMUX_PAD(0x328, 0x7C, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN)
#define MX50_PAD_SSI_RXC__GPIO_6_5	IOMUX_PAD(0x32C, 0x80, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_DOWN)
...
// Joseph 20110614 	#define MX50_PAD_CSPI_SS0__GPIO_4_11	IOMUX_PAD(0x36C, 0xC0, 1, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_CSPI_SS0__GPIO_4_11	IOMUX_PAD(0x36C, 0xC0, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
...
/* HP detect */
#define MX50_PAD_ECSPI1_SS0__GPIO_4_15	IOMUX_PAD(0x37C, 0xD0, 1, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_ECSPI1_SS0__GPIO_4_15_PUINT	IOMUX_PAD(0x37C, 0xD0, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
...
#define MX50_PAD_ECSPI2_MISO__GPIO_4_18	IOMUX_PAD(0x388, 0xDC, 1, 0x0, 0, NO_PAD_CTRL)
...
#define MX50_PAD_SD2_WP_HWID0__GPIO_5_16	IOMUX_PAD(0x3D0, 0x124, 1, 0x0, 0, NO_PAD_CTRL)
...
#define MX50_PAD_SD3_D7__GPIO_5_27_PU	IOMUX_PAD(0x468, 0x188, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
...
#define MX50_PAD_EPDC_PWRSTAT__GPIO_3_28_INT	IOMUX_PAD(0x5BC, 0x220, 1, 0x0, 0, PAD_CTL_PKE | PAD_CTL_PUE | PAD_CTL_PUS_100K_UP)
...
#define MX50_PAD_EPDC_BDR0__GPIO_4_23	IOMUX_PAD(0x5D8, 0x23C, 1, 0x0, 0, MX50_KEYPAD_CTRL)
...
#define MX50_PAD_SD1_CMD__SD1_CMD_DSM	IOMUX_PAD(0x394, 0xE8, \
					IOMUX_CONFIG_SION, 0x0, 0, \
					MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD1_CLK__SD1_CLK_DSM	IOMUX_PAD(0x390, 0xE4, \
					IOMUX_CONFIG_SION, 0x0, 0, \
					MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD1_D0__SD1_D0_DSM	IOMUX_PAD(0x398, 0xEC, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD1_D1__SD1_D1_DSM	IOMUX_PAD(0x39C, 0xF0, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD1_D2__SD1_D2_DSM	IOMUX_PAD(0x3A0, 0xF4, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD1_D3__SD1_D3_DSM	IOMUX_PAD(0x3A4, 0xF8, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)



#define MX50_PAD_SD1_CMD__SD1_CMD_DSL	IOMUX_PAD(0x394, 0xE8, \
					IOMUX_CONFIG_SION, 0x0, 0, \
					MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD1_CLK__SD1_CLK_DSL	IOMUX_PAD(0x390, 0xE4, \
					IOMUX_CONFIG_SION, 0x0, 0, \
					MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD1_D0__SD1_D0_DSL	IOMUX_PAD(0x398, 0xEC, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD1_D1__SD1_D1_DSL	IOMUX_PAD(0x39C, 0xF0, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD1_D2__SD1_D2_DSL	IOMUX_PAD(0x3A0, 0xF4, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD1_D3__SD1_D3_DSL	IOMUX_PAD(0x3A4, 0xF8, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
...
#define MX50_PAD_SD2_CLK__SD2_CLK_DSL	IOMUX_PAD(0x3A8, 0xFC, \
						IOMUX_CONFIG_SION, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD2_CMD__SD2_CMD_DSL	IOMUX_PAD(0x3AC, 0x100, \
						IOMUX_CONFIG_SION, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD2_D0__SD2_D0_DSL	IOMUX_PAD(0x3B0, 0x104, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD2_D1__SD2_D1_DSL	IOMUX_PAD(0x3B4, 0x108, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD2_D2__SD2_D2_DSL	IOMUX_PAD(0x3B8, 0x10C, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD2_D3__SD2_D3_DSL	IOMUX_PAD(0x3BC, 0x110, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)

#define MX50_PAD_SD2_CLK__SD2_CLK_DSM	IOMUX_PAD(0x3A8, 0xFC, \
						IOMUX_CONFIG_SION, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD2_CMD__SD2_CMD_DSM	IOMUX_PAD(0x3AC, 0x100, \
						IOMUX_CONFIG_SION, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD2_D0__SD2_D0_DSM	IOMUX_PAD(0x3B0, 0x104, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD2_D1__SD2_D1_DSM	IOMUX_PAD(0x3B4, 0x108, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD2_D2__SD2_D2_DSM	IOMUX_PAD(0x3B8, 0x10C, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD2_D3__SD2_D3_DSM	IOMUX_PAD(0x3BC, 0x110, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)

#define MX50_PAD_SD2_CLK__SD2_CLK_WIFI	IOMUX_PAD(0x3A8, 0xFC, \
						IOMUX_CONFIG_SION, 0x0, 0, \
						MX50_SD_WIFI_PAD_CLK)
#define MX50_PAD_SD2_CMD__SD2_CMD_WIFI	IOMUX_PAD(0x3AC, 0x100, \
						IOMUX_CONFIG_SION, 0x0, 0, \
						MX50_SD_WIFI_PAD_CMD)
#define MX50_PAD_SD2_D0__SD2_D0_WIFI	IOMUX_PAD(0x3B0, 0x104, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_DAT)
#define MX50_PAD_SD2_D1__SD2_D1_WIFI	IOMUX_PAD(0x3B4, 0x108, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_DAT)
#define MX50_PAD_SD2_D2__SD2_D2_WIFI	IOMUX_PAD(0x3B8, 0x10C, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_DAT)
#define MX50_PAD_SD2_D3__SD2_D3_WIFI	IOMUX_PAD(0x3BC, 0x110, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_DAT)
...
#define MX50_PAD_SD3_CMD__SD3_CMD_DSL	IOMUX_PAD(0x444, 0x164, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD3_CLK__SD3_CLK_DSL	IOMUX_PAD(0x448, 0x168, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD3_D0__SD3_D0_DSL	IOMUX_PAD(0x44C, 0x16C, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD3_D1__SD3_D1_DSL	IOMUX_PAD(0x450, 0x170, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD3_D2__SD3_D2_DSL	IOMUX_PAD(0x454, 0x174, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD3_D3__SD3_D3_DSL	IOMUX_PAD(0x458, 0x178, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD3_D4__SD3_D4_DSL	IOMUX_PAD(0x45C, 0x17C, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD3_D5__SD3_D5_DSL	IOMUX_PAD(0x460, 0x180, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD3_D6__SD3_D6_DSL	IOMUX_PAD(0x464, 0x184, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)
#define MX50_PAD_SD3_D7__SD3_D7_DSL	IOMUX_PAD(0x468, 0x188, 0, 0x0, 0, \
						MX50_SD_DSL_PAD_CTRL)


#define MX50_PAD_SD3_CMD__SD3_CMD_DSM	IOMUX_PAD(0x444, 0x164, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD3_CLK__SD3_CLK_DSM	IOMUX_PAD(0x448, 0x168, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD3_D0__SD3_D0_DSM	IOMUX_PAD(0x44C, 0x16C, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD3_D1__SD3_D1_DSM	IOMUX_PAD(0x450, 0x170, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD3_D2__SD3_D2_DSM	IOMUX_PAD(0x454, 0x174, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD3_D3__SD3_D3_DSM	IOMUX_PAD(0x458, 0x178, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD3_D4__SD3_D4_DSM	IOMUX_PAD(0x45C, 0x17C, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD3_D5__SD3_D5_DSM	IOMUX_PAD(0x460, 0x180, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD3_D6__SD3_D6_DSM	IOMUX_PAD(0x464, 0x184, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)
#define MX50_PAD_SD3_D7__SD3_D7_DSM	IOMUX_PAD(0x468, 0x188, 0, 0x0, 0, \
						MX50_SD_DSM_PAD_CTRL)


#define MX50_PAD_SD3_CMD__SD3_CMD_DSH	IOMUX_PAD(0x444, 0x164, 0, 0x0, 0, \
						MX50_SD_DSH_PAD_CTRL)
#define MX50_PAD_SD3_CLK__SD3_CLK_DSH	IOMUX_PAD(0x448, 0x168, 0, 0x0, 0, \
						MX50_SD_DSH_PAD_CTRL)
#define MX50_PAD_SD3_D0__SD3_D0_DSH	IOMUX_PAD(0x44C, 0x16C, 0, 0x0, 0, \
						MX50_SD_DSH_PAD_CTRL)
#define MX50_PAD_SD3_D1__SD3_D1_DSH	IOMUX_PAD(0x450, 0x170, 0, 0x0, 0, \
						MX50_SD_DSH_PAD_CTRL)
#define MX50_PAD_SD3_D2__SD3_D2_DSH	IOMUX_PAD(0x454, 0x174, 0, 0x0, 0, \
						MX50_SD_DSH_PAD_CTRL)
#define MX50_PAD_SD3_D3__SD3_D3_DSH	IOMUX_PAD(0x458, 0x178, 0, 0x0, 0, \
						MX50_SD_DSH_PAD_CTRL)
#define MX50_PAD_SD3_D4__SD3_D4_DSH	IOMUX_PAD(0x45C, 0x17C, 0, 0x0, 0, \
						MX50_SD_DSH_PAD_CTRL)
#define MX50_PAD_SD3_D5__SD3_D5_DSH	IOMUX_PAD(0x460, 0x180, 0, 0x0, 0, \
						MX50_SD_DSH_PAD_CTRL)
#define MX50_PAD_SD3_D6__SD3_D6_DSH	IOMUX_PAD(0x464, 0x184, 0, 0x0, 0, \
						MX50_SD_DSH_PAD_CTRL)
#define MX50_PAD_SD3_D7__SD3_D7_DSH	IOMUX_PAD(0x468, 0x188, 0, 0x0, 0, \
						MX50_SD_DSH_PAD_CTRL)


#define MX50_PAD_SD3_CMD__SD3_CMD_WIFI	IOMUX_PAD(0x444, 0x164, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_CMD)
#define MX50_PAD_SD3_CLK__SD3_CLK_WIFI	IOMUX_PAD(0x448, 0x168, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_CLK)
#define MX50_PAD_SD3_D0__SD3_D0_WIFI	IOMUX_PAD(0x44C, 0x16C, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_DAT)
#define MX50_PAD_SD3_D1__SD3_D1_WIFI	IOMUX_PAD(0x450, 0x170, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_DAT)
#define MX50_PAD_SD3_D2__SD3_D2_WIFI	IOMUX_PAD(0x454, 0x174, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_DAT)
#define MX50_PAD_SD3_D3__SD3_D3_WIFI	IOMUX_PAD(0x458, 0x178, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_DAT)
#define MX50_PAD_SD3_D4__SD3_D4_WIFI	IOMUX_PAD(0x45C, 0x17C, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_DAT)
#define MX50_PAD_SD3_D5__SD3_D5_WIFI	IOMUX_PAD(0x460, 0x180, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_DAT)
#define MX50_PAD_SD3_D6__SD3_D6_WIFI	IOMUX_PAD(0x464, 0x184, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_DAT)
#define MX50_PAD_SD3_D7__SD3_D7_WIFI	IOMUX_PAD(0x468, 0x188, 0, 0x0, 0, \
						MX50_SD_WIFI_PAD_DAT)
...
#define MX50_PAD_UART2_RTS__UART2_RTS	IOMUX_PAD(0x34C, 0xA0, 0, 0x7c8, 3, \
						MX50_UART_PAD_CTRL)
#define MX50_PAD_UART3_TXD__UART3_TXD	IOMUX_PAD(0x350, 0xA4, 0, 0x0, 0, \
						MX50_UART_PAD_CTRL)
#define MX50_PAD_UART3_RXD__UART3_RXD	IOMUX_PAD(0x354, 0xA8, 0, 0x7d4, 1, \
						MX50_UART_PAD_CTRL)
...
#define MX50_PAD_EPDC_D7__EPDC_D7	IOMUX_PAD(0x568, 0x1CC, 0, 0x0, 0, \
						MX50_EPDC_PAD_CTRL)
#define MX50_PAD_EPDC_D8__EPDC_D8	IOMUX_PAD(0x56C, 0x1D0, 0, 0x0, 0, \
						MX50_EPDC_PAD_CTRL)
#define MX50_PAD_EPDC_D9__EPDC_D9	IOMUX_PAD(0x570, 0x1D4, 0, 0x0, 0, \
						MX50_EPDC_PAD_CTRL)
#define MX50_PAD_EPDC_D10__EPDC_D10	IOMUX_PAD(0x574, 0x1D8, 0, 0x0, 0, \
						MX50_EPDC_PAD_CTRL)
#define MX50_PAD_EPDC_D11__EPDC_D11	IOMUX_PAD(0x578, 0x1DC, 0, 0x0, 0, \
						MX50_EPDC_PAD_CTRL)
#define MX50_PAD_EPDC_D12__EPDC_D12	IOMUX_PAD(0x57C, 0x1E0, 0, 0x0, 0, \
						MX50_EPDC_PAD_CTRL)
#define MX50_PAD_EPDC_D13__EPDC_D13	IOMUX_PAD(0x580, 0x1E4, 0, 0x0, 0, \
						MX50_EPDC_PAD_CTRL)
#define MX50_PAD_EPDC_D14__EPDC_D14	IOMUX_PAD(0x584, 0x1E8, 0, 0x0, 0, \
						MX50_EPDC_PAD_CTRL)
#define MX50_PAD_EPDC_D15__EPDC_D15	IOMUX_PAD(0x588, 0x1EC, 0, 0x0, 0, \
						MX50_EPDC_PAD_CTRL)
...
//							MX50_EPDC_PAD_CTRL)
#define MX50_PAD_EPDC_SDSHR__EPDC_SDSHR	IOMUX_PAD(0x5B4, 0x218, 0, 0x0, 0, \
							(PAD_CTL_PKE | PAD_CTL_PUE |PAD_CTL_PUS_22K_UP|PAD_CTL_DSE_MAX))
...
// MPU control pins
#define MX50_PAD_EPDC_D0__ELCDIF_RS			IOMUX_PAD(0x54C, 0x1B0, 3, 0x0, 0, NO_PAD_CTRL)
//#define MX50_PAD_EPDC_D1__GPIO_3_1			IOMUX_PAD(0x550, 0x1B4, 1, 0x0, 0, NO_PAD_CTRL)	// chip select ¥?gpio ¥\¯?
#define MX50_PAD_EPDC_D2__ELCDIF_WR_RWN		IOMUX_PAD(0x554, 0x1B8, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_D3__ELCDIF_RD_E		IOMUX_PAD(0x558, 0x1BC, 3, 0x0, 0, NO_PAD_CTRL)

// MPU data pins
#define MX50_PAD_EPDC_SDCE5__ELCDIF_D0		IOMUX_PAD(0x5F4, 0x258, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_SDCE4__ELCDIF_D1		IOMUX_PAD(0x5F0, 0x254, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_SDCE3__ELCDIF_D2		IOMUX_PAD(0x5EC, 0x250, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_SDCE2__ELCDIF_D3		IOMUX_PAD(0x5E8, 0x24C, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_SDCE1__ELCDIF_D4		IOMUX_PAD(0x5E4, 0x248, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_SDCE0__ELCDIF_D5		IOMUX_PAD(0x5E0, 0x244, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_BDR1__ELCDIF_D6		IOMUX_PAD(0x5DC, 0x240, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_BDR0__ELCDIF_D7		IOMUX_PAD(0x5D8, 0x23C, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_SDLE__ELCDIF_D8		IOMUX_PAD(0x5AC, 0x210, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_SDCLKN__ELCDIF_D9		IOMUX_PAD(0x5B0, 0x214, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_SDSHR__ELCDIF_D10		IOMUX_PAD(0x5B4, 0x218, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_PWRCOM__ELCDIF_D11	IOMUX_PAD(0x5B8, 0x21C, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_PWRSTAT__ELCDIF_D12	IOMUX_PAD(0x5BC, 0x220, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_PWRCTRL0__ELCDIF_D13	IOMUX_PAD(0x5C0, 0x224, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_PWRCTRL1__ELCDIF_D14	IOMUX_PAD(0x5C4, 0x228, 3, 0x0, 0, NO_PAD_CTRL)
#define MX50_PAD_EPDC_PWRCTRL2__ELCDIF_D15	IOMUX_PAD(0x5C8, 0x22C, 3, 0x0, 0, NO_PAD_CTRL)

// display control gpio
// #define MX50_PAD_DISP_RS__GPIO_2_17			IOMUX_PAD(0x434, 0x154, 1, 0x0, 0, NO_PAD_CTRL)
// #define MX50_PAD_DISP_BUSY__GPIO_2_18		IOMUX_PAD(0x43C, 0x15C, 1, 0x0, 0, MX50_ELCDIF_PAD_CTRL)
// #define MX50_PAD_DISP_RESET__GPIO_2_20		IOMUX_PAD(0x440, 0x160, 1, 0x0, 0, NO_PAD_CTRL)
